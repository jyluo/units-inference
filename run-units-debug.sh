...
# Inference
$CFI/scripts/inference-dev -m ROUNDTRIP --checker "$CHECKER" --solver "$DEBUG_SOLVER" --solverArgs="collectStatistics=true,writeSolutions=true,noAppend=true" --hacks="$IS_HACK" -afud ./annotated "$@"
