...
class Variables {
    ...
    void customUnitForInsertion() {
        // :: fixable-error: (assignment.type.incompatible)
        @UnitsInternal(unknownUnits = false, unitsBottom = false, prefixExponent = 4, baseUnits = {@BaseUnit(unit = m.class, exponent = 12), @BaseUnit(unit = s.class, exponent = -34) }) Integer x = 50;
    }
}
