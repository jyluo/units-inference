...
class Variables {
    ...
    void customUnitForInsertion() {
        // :: fixable-error: (assignment.type.incompatible)
        @UnitsInternal(unknownUnits = false, unitsBottom = false, prefixExponent = 4, baseUnitComponents = {@BUC(unit = m.class, exponent = 12), @BUC(unit = s.class, exponent = -34) }) Integer x = 50;
    }
}
