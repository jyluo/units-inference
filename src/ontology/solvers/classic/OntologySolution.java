...
public class OntologySolution implements InferenceSolution {
  ...
  public OntologySolution(
      Collection<SequenceSolution> solutions, ProcessingEnvironment processingEnv) {
    ...
    for (Map.Entry<Integer, EnumSet<OntologyValue>> entry : results.entrySet()) {
      ...
      AnnotationMirror anno =
          OntologyUtils.createOntologyAnnotationByValues(
              processingEnv, values.toArray(new OntologyValue[values.size()]));
