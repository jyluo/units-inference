...
public class OntologyConstraintSolver extends ConstraintSolver {
  ...
  @Override
  protected InferenceSolution graphSolve(
    ...
    for (Map.Entry<Vertex, Set<Constraint>> entry : constraintGraph.getConstantPath().entrySet()) {
      ...
      AnnotationMirror CUR_ONTOLOGY_BOTTOM =
          OntologyUtils.createOntologyAnnotationByValues(processingEnvironment, ontologyValues);
      TwoQualifiersLattice latticeFor2 =
          configureLatticeFor2(OntologyUtils.ONTOLOGY_TOP, CUR_ONTOLOGY_BOTTOM);
  ...
  @Override
  protected InferenceSolution mergeSolution(
      List<Map<Integer, AnnotationMirror>> inferenceSolutionMaps) {
  ...
  protected EnumSet<OntologyValue> lubOfOntologyValues(
  ...
  @Override
  protected Map<Integer, AnnotationMirror> inferMissingConstraint(
